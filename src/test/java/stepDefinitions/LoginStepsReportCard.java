...
//import web.DashboardPage;
//import web.MarksheetPage;
//import web.ReportCardPage;
//import web.SimonsLoginPage;
//import utilities.BrowserUtils;
...
public class LoginStepsReportCard {
    ...
    // WEB SPECIFIC STEPS (without "android" keyword)
    
    @Given("I am on the application login page")
    public void i_am_on_the_application_login_page() {
        System.out.println("Starting Web Test");
        // Web implementation
    }
    
    @When("I login with valid admin credentials for {string}")
    public void i_login_with_valid_admin_credentials_for_user(String userType) {
        System.out.println("Web login for: " + userType);
        // Web implementation
    }
    ...
    public void i_scroll_down_to_academic_progress_section() {
        System.out.println("Web: Scroll to Academic Progress");
        // Web implementation
    }
    
    @And("I click on Marksheet option")
    public void i_click_on_marksheet_option() {
        System.out.println("Web: Click on Marksheet");
        // Web implementation
    }
    
    @And("I select current academic year from dropdown")
    public void i_select_current_academic_year_from_dropdown() {
        System.out.println("Web: Select academic year");
        // Web implementation
    }
    
    @And("I select a student from student dropdown")
    public void i_select_a_student_from_student_dropdown() {
        System.out.println("Web: Select student");
        // Web implementation
    }
    
    @When("I click on View button for report card")
    public void i_click_on_view_button_for_report_card() {
        System.out.println("Web: Click View button");
        // Web implementation
    }
    
    @Then("I should see report card details page")
    public void i_should_see_report_card_details_page() {
        System.out.println("Web: Verify report card page");
        // Web implementation
    }
    
    @When("I click on Download button")
    public void i_click_on_download_button() {
        System.out.println("Web: Click Download button");
        // Web implementation
    }
    
    @Then("report card file should download successfully")
    public void report_card_file_should_download_successfully() {
        System.out.println("Web: Report card downloaded");
        // Web implementation
    }
    
    @Then("report card file should download successfully for {string}")
    public void report_card_file_should_download_successfully_for_user(String userType) {
        System.out.println("Web: Report card downloaded for " + userType);
        // Web implementation
    }
    
    @Then("I should see marksheet page")
    public void i_should_see_marksheet_page() {
        System.out.println("Web: Verify marksheet page");
        // Web implementation
    }
    
    @And("academic year dropdown should be visible")
    public void academic_year_dropdown_should_be_visible() {
        System.out.println("Web: Academic year dropdown visible");
        // Web implementation
    }
    
    @And("student dropdown should be visible")
    public void student_dropdown_should_be_visible() {
        System.out.println("Web: Student dropdown visible");
        // Web implementation
    }
    
    @Then("page title should contain {string}")
    public void page_title_should_contain(String expectedTitle) {
        System.out.println("Web: Page title contains: " + expectedTitle);
        // Web implementation
    }
}
